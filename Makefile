...
Release_x86:
	...
	i686-w64-mingw32-c++ -mwindows -s -O2 -DGCCcompiler -DSDL_Path='"../ThirdParty/x86/include/SDL2/SDL.h"' -DRelease=true -L./ThirdParty/x86/lib main.cpp ./Implement/*.cpp -lRPK -lSDL2main -lSDL2 -lSDL2_image -o ./Build/Release_x86/main my.o
