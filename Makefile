Debug_x86:
	...
	./Toolchain/RadiPako ./Assets/* -o ./Build/Debug_x86/Assets/Sprites.rpk
	i686-w64-mingw32-c++ -L./ThirdParty/x86/lib main.cpp ./Implement/*.cpp -lRPK -lSDL2main -lSDL2 -lSDL2_image -o ./Build/Debug_x86/main
...
Release_x86:
	...
	i686-w64-mingw32-c++ -mwindows -s -O2 -DRelease=true -L./ThirdParty/x86/lib main.cpp ./Implement/*.cpp -lRPK -lSDL2main -lSDL2 -lSDL2_image -o ./Build/Release_x86/main my.o
